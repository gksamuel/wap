...
public class Login extends HttpServlet {
    ...
    private static final long serialVersionUID = 1029888847441429728L;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            seekerSession = seekerSession.login(request.getParameter("username"), request.getParameter("password"));
            if (seekerSession.getId() != null) {
                ...
                if (seekerSession.getExpiry().before(new Date())) {
                    response.sendRedirect("/m/expired.jsp");
                }
